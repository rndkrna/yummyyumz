...
export default function Footer() {
  ...
  const handleSubmit = async (event) => {
    ...
    setFormStatus(
      orderResult.source === "supabase"
        ? "Pesan tercatat di dashboard admin. WhatsApp dibuka untuk konfirmasi."
  ...
  return (
    <footer
      className="bg-bakeryPeach relative z-10 overflow-hidden"
      ref={containerRef}
    >
      ...
      <div className="pt-32 pb-16 flex flex-col items-center justify-center px-4 relative z-20">
        <h2
          ref={titleRef}
          className="font-display font-extrabold text-bakeryBerry text-[clamp(2.5rem,8vw,8rem)] text-center tracking-tighter uppercase leading-[0.8] mb-12"
          style={{
            WebkitTextStroke: "2px #4A3E3D",
            textShadow: "6px 6px 0 #4A3E3D",
          }}
        >
          BISA DIKIRIM
          <br />
        ...
        <div
          ref={archRef}
          className="w-[80vw] max-w-[500px] h-[400px] md:h-[500px] bg-[#96cba1] rounded-t-full border-4 border-bakeryText flex items-center justify-center relative shadow-[0_20px_0_rgba(74,62,61,0.2)]"
        >
          <div
            ref={boxRef}
          ...
          >
            ...
            <span className="font-display font-extrabold text-bakeryBerry text-3xl z-10 bg-white px-2 border-2 border-bakeryBerry">
              YUMMY BENTO
            </span>
          </div>
      ...
      <div
        id="cta"
        className="bg-bakeryBg py-32 px-8 md:px-16 border-t-2 border-bakeryText mt-16 relative z-10"
      >
        <div className="max-w-[1400px] mx-auto grid min-w-0 grid-cols-1 gap-12 items-center lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,1.1fr)] lg:gap-16">
          <div className="min-w-0 overflow-hidden">
            <h2 className="font-display font-extrabold text-[clamp(2.6rem,6vw,5.25rem)] text-bakeryBerry uppercase leading-[0.92] tracking-tighter mb-8 break-words">
              PUNYA PERTANYAAN?
              <br />
              KAMI ADA JAWABANNYA!
            </h2>
            <p className="font-body text-bakeryText text-lg max-w-lg mb-8">
              Form ini tidak lagi berhenti di halaman saja. Setelah diisi, kami
              siapkan pesan WhatsApp yang bisa langsung Anda kirim ke admin.
            </p>
          ...
          <div className="min-w-0 bg-bakeryBerry p-8 md:p-12 rounded-3xl border-2 border-bakeryText shadow-[10px_10px_0_rgba(74,62,61,1)]">
            <form className="flex flex-col space-y-8" onSubmit={handleSubmit}>
              <input
                ...
                className="bg-transparent border-b-2 border-white/30 pb-2 text-white font-body placeholder-white/50 focus:outline-none focus:border-white transition-colors"
              />
              ...
              <button
                type="submit"
                className="self-start border-2 border-white text-white rounded-full px-8 py-3 font-display font-bold uppercase hover:bg-white hover:text-bakeryBerry transition-colors"
                data-cursor-hover
              >
                Kirim Pesan
              </button>
